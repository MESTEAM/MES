...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MES.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("ME", "w")  
...
if tonumber(user_id) == tonumber(970627200) then  
var = true  
elseif tonumber(user_id) == tonumber(4444455555) then
var = true 
...
send(msg.chat_id_, msg.id_,MES_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf MES.lua')
os.execute('wget https://raw.githubusercontent.com/MESTEAM/MES/main/MES.lua')
send(msg.chat_id_, msg.id_,' ✫︙ تم تحديث السورس \n ✫︙ لديك اخر اصدار لسورس ميس\n ✫︙ الاصدار » { 1.3v}')
dofile('MES.lua')  
end
if text == 'الاصدار ✫' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫︙ اصدار سورس ميس \n ✫︙ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'✫︙  عدد الكروبات الان » { '..#group..' }'..MESk..''..MES..'\n✫︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local MES1_Msg = database:get(bot_id.."MES1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MES1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✫︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'WviivW')..') \n ✫︙ '..MES1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MES_Msg and not Special(msg) then  
local MES_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MES_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✫︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✫︙ ["..MES_Msg.."] \n")
else
send(msg.chat_id_,0," ✫︙ العضو : {["..data.first_name_.."](T.ME/WviivW)}\n ✫︙ ["..MES_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✫︙ عذرا » {["..data.first_name_.."](T.ME/WviivW)}\n ✫︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✫︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'WviivW')..') \n ✫︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✫︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'WviivW')..') \n ✫︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✫︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n ✫︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✫︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✫︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
...
database:set(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✫︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MES1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MES1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✫︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MES1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MES1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MES1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✫︙ ارسل الكلمه الان")  
database:set(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MES1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MES1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MES1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MES1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MES1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MES1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✫︙ قائمة المنع \n≪━━━━━━𝗠𝗘━━━━━━≫\n"
for k,v in pairs(list) do  
local MES_Msg = database:get(bot_id.."MES1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MES_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✫︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'WviivW')..')'..'\n ✫︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'✫︙تم تنظيف الرسائل المعدله ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ميس')
local MES_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..MES_Msg[math.random(#MES_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميس').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MESdx(msg.chat_id_, msg.id_, ' ✫︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✫︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✫︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✫︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ✫︙ٴ≪━━━━━━𝗠𝗘━━━━━━≫ٴ✫︙○ٴ\n✫︙ 彡 .[𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝑺 𓆪](t.me/WviivW)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ميس')
...
MES = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MES)
...
------------------------------------------------------------------------
local MESAbot = database:get(bot_id.."MES1:Add:Filter:Rp2"..text..result.chat_id_)   
if MESAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✫︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✫︙ ["..MESAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MES1_Msg = database:get(bot_id.."MES1:Add:Filter:Rp2"..text..result.chat_id_)   
if MES1_Msg then    
send(msg.chat_id_, msg.id_," ✫︙ "..MES1_Msg)
